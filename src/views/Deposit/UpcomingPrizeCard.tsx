...
import { PrizeTier } from '@losslessproject/client-js'
  ...
  return (
    <h1
      className={classNames(
        'text-10xl xs:text-13xl xs:-mt-0 font-semibold text-flashy pointer-events-none mx-auto leading-none relative',
        { 'opacity-50': !amount }
      )}
    >
